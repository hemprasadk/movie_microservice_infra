...
data "aws_iam_policy_document" "dynamodb_access" {
  statement {
    ...
    resources = ["arn:aws:dynamodb:${local.region}:${data.aws_caller_identity.current.account_id}:table/movie-details-table","arn:aws:dynamodb:${local.region}:${data.aws_caller_identity.current.account_id}:table/movie-details-table/index/*"]
  }
